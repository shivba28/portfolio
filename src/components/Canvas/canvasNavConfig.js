...
export const MINIMAP_NODES = [
  { id: 'canvas-center', left: 0, top: 0, w: 720, h: 160, color: '#868686' },
  { id: 'card-hero', left: 0, top: 0, w: 720, h: 160, color: '#FFE94A' },
  ...
  { id: 'card-about', left: -1040, top: -720, w: 280, h: 420, color: '#f5f0e8' },
...
export const MINIMAP_DOM_SKIP = new Set(['card-hero', 'card-about']);
