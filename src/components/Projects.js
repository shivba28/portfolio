...
export const Project = () => {
    ...
    return(
        <section className="project">
            ...
            <section className="project-content section my-5 py-5" id="project" data-aos="fade-up" data-aos-offset={dataAosOffset} data-aos-duration="1500" data-aos-once="false">
