            ...
            <Row>
                ...
                <Col xs={12} md={6}>
                    <div className="card-container my-5">
                        <div className="skill-card" id='card1' data-aos="fade-right" data-aos-once="false" data-aos-offset="200">
                        ...
                        <div className="skill-card" id='card2' data-aos="fade-right" data-aos-once="false" data-aos-offset="200" data-aos-delay="500">
                            <div className="background">
                                <Clouds />
                                <Stars />
                            </div>
                        ...
                        <div className="skill-card" id='card3' data-aos="fade-right" data-aos-once="false" data-aos-offset="500" data-aos-delay="500">
                            <div className="background">
                                <Clouds />
                                <Stars />
                            </div>
                        ...
                        <div className="skill-card" id='card4' data-aos="fade-right" data-aos-once="false" data-aos-offset="500" data-aos-delay="1000">
                            <div className="background">
                                <Clouds />
                                <Stars />
                            </div>
